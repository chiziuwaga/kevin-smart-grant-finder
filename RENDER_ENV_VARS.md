...
**How to get:**
1. Go to https://auth0.com → Create tenant
...
2. Create Product → Set price to $35/month → Copy Price ID
...
- ✅ `CELERY_BROKER_URL` (auto-populated from Redis)
- ✅ `CELERY_RESULT_BACKEND` (auto-populated from Redis)
...
|---------|----------|----------|
| **Auth0** | AUTH0_DOMAIN, AUTH0_API_AUDIENCE | 🔴 Critical |
