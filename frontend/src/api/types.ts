...
export interface EnrichedGrant extends Omit<Grant, 'score' | 'funding_amount' | 'eligibility_criteria'> {
...
export interface ApplicationFeedbackData {
    ...
    status: 'Draft' | 'Submitted' | 'Under Review' | 'Awarded' | 'Rejected' | 'Withdrawn' | 'Other';
